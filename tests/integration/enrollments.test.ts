...
describe("GET /enrollments/cep", () => {
  ...
  it("should respond with status 204 when CEP is valid → should respond with status 204 when CEP in invalid.", async () => {
...
describe("POST /enrollments", () => {
  ...
  describe("when token is valid", () => {
    ...
    describe("when body is invalid", () => {
      ...
      it("should respond with status 400 and create new enrollment if there is not any → should respond with status 400 when body is invalid.", async () => {
